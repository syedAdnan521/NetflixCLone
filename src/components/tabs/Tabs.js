...
const Tabs = ({ activeTabName, onClickTab }) => {
  const { CANCEL_AT_ANY_TIME, PICK_YOUR_PRICE, WATCH_ANYWHWERE } = tabLabels;
        ...
        <section className="tab-content">
          <div className="container">
            <div
              id="tab-2-content"
              className={`tab-content-item ${
                activeTabName === WATCH_ANYWHWERE && "show"
              }`}
            >
          ...
          <div className="container">
            ...
            >
              ...
              <table className="table">
                ...
                <tbody>
                  <tr>
                    <td>Monthly price after free month ends on 25/3/2022</td>
                    <td>$6.99</td>
                    <td>$11.99</td>
                    <td>$15.99</td>
                  </tr>
